...
{ id:'a-not-a-ban', title:`The Word For It`, who:C.press, min:1, max:10, tags:['immigration','press'],
  ...
  text:`The order names six countries. Every one of them is majority-Muslim, which is either a coincidence or a policy, ` +
       `and Kaylee has the question she will field forty times today before she fields it once.`,
  choices:[
    { label:`"This is not a religious ban." Full stop, no elaboration.`, eff:{base:+6,courts:-6,street:-6,press:-5,auth:+6},
      res:`The line gets repeated so often it starts testifying against itself; four campaign clips surface within a day, and all four are on tape, in your voice, undenied.` },
    { label:`Name the security rationale. Publish the threat assessment.`, eff:{courts:+7,street:+6,press:+6,congress:+4,base:-6,auth:+2},
      res:`The assessment backs two of the six countries and quietly demolishes the other four. Honesty turns out to be the expensive option, and it costs you two-thirds of the order.` },
    { label:`Say it is exactly what it looks like.`, eff:{base:+9,courts:-9,street:-9,press:-5,congress:-6,auth:+7}, breaks:'religion',
      res:`Candour is thrilling right up until a court reporter transcribes it, at which point it stops being a personality trait and becomes Exhibit A.` },
    { label:`Add a majority-Christian country to the list for balance.`, eff:{base:+3,street:-5,press:-5,courts:-4,auth:+3}, wild:true,
      res:`Liechtenstein. Population 40,000, zero asylum seekers on record, and a foreign ministry that answers with a statement of such bemused solidarity it outlives your administration.` }]},
...
{ id:'a-second-draft', title:`The Third Draft`, who:C.ag, min:2, max:14, tags:['courts','immigration'],
  ...
  text:`"Two versions struck down. This is the third." Bo lays it out. "Same six countries. What's new is four ` +
       `paragraphs of process bolted onto the front, and those four paragraphs are the entire legal strategy."`,
  choices:[
    { label:`Sign the third draft. Let the paragraphs do the work.`, eff:{base:+7,courts:-5,street:-6,press:-4,auth:+8},
      res:`It survives review. Nobody outside four law schools will ever read the paragraphs, and the paragraphs are the only reason any of this is still legal.` },
    { label:`Sign it and say publicly it is the same order.`, eff:{base:+8,courts:-10,street:-7,press:-5,auth:+5}, breaks:'religion',
      res:`One rally aside undoes four paragraphs of careful lawyering. It is struck down a fourth time and your own sentence gets quoted back at you in the opinion.` },
    { label:`Abandon it. Two courts is two courts.`, eff:{courts:+9,street:+8,press:+7,congress:+5,base:-9,auth:-4},
      res:`Nothing gets signed. The policy dies without a sound, and your base absorbs the lesson that a judge can simply end things, which is not a lesson you wanted taught this early.` },
    { label:`Sign all three versions simultaneously.`, eff:{base:+3,courts:-6,press:-5,street:-4,auth:+4}, wild:true,
      res:`Three contradictory orders now govern the same border at once. Customs asks for clarification four times and receives, each time, all three orders stapled together.` }]},
...
{ id:'a-language-denial', title:`The Language Used`, who:C.cos, min:2, max:16, tags:['press','rhetoric'],
  ...
  text:`Two people in the room remember exactly what you said about certain countries. ` +
       `Deborah has drafted a denial. "It disputes the wording, not the meeting. Sir, that is a very narrow door to hide behind."`,
  choices:[
    { label:`Post the narrow denial. Do not elaborate.`, eff:{base:+6,press:-5,street:-6,congress:-4,auth:+5},
      res:`Four people in that room decline to back you up. Years later you confirm the phrase yourself, on camera, apparently having forgotten you ever denied it.` },
    { label:`Deny nothing. Say the meeting was private.`, eff:{base:+5,press:-3,congress:-3,auth:+6},
      res:`Refusing to engage beats a denial that can be fact-checked. It holds, cleanly, for four straight years.` },
    { label:`Confirm it and defend the underlying point.`, eff:{base:+8,street:-10,press:-5,congress:-7,courts:-4,auth:+6},
      res:`Nine ambassadors request meetings within the week. The State Department schedules all nine and briefs each one a slightly different version of events.` },
    { label:`Blame a translation error. There was no translator.`, eff:{base:+3,press:-5,street:-4,congress:-3,auth:+2}, wild:true,
      res:`Everybody in the room spoke English, a fact that is immediately pointed out. You call the error "conceptual," a claim nobody can disprove because nobody can parse it.` }]},
...
{ id:'a-wall-emergency', title:`The Emergency For The Wall`, who:C.cos, min:6, max:16, tags:['power','congress'],
  ...
  text:`Congress voted you $1.4 billion and declined the rest, in a vote, four days ago. ` +
       `"An emergency declaration unlocks military construction money regardless," Bo says. "Congress said no. That's the whole emergency."`,
  choices:[
    { label:`Declare it. Take the construction money.`, eff:{base:+9,congress:-12,courts:-8,press:-5,street:-5,auth:+12}, breaks:'presentment',
      res:`You've converted a lost vote into a won one by simply calling the loss an emergency. Both chambers pass a resolution terminating it and you veto that too.` },
    { label:`Declare it but spend only the counter-narcotics line.`, eff:{base:+5,congress:-6,courts:-4,press:-3,auth:+8},
      res:`Less photogenic, less litigated, identical concrete. Nobody protests a line item about drug interdiction, which turns out to be the whole trick.` },
    { label:`Build what $1.4 billion buys. Say it was always the plan.`, eff:{congress:+8,courts:+6,press:+5,base:-7,auth:+2},
      res:`Ninety miles, on budget, finished early, built exactly where the engineers actually recommended. It goes entirely unremarked upon, which is apparently the price of competence.` },
    { label:`Declare an emergency about the shortage of emergencies.`, eff:{base:+3,congress:-6,courts:-5,press:-4,auth:+5}, wild:true,
      res:`The Federal Register publishes it, because the Federal Register publishes whatever it is handed. Four agencies request implementing guidance that nobody ever writes.` }]},
...
{ id:'a-blood', title:`The Line About Blood`, who:C.writer, min:8, max:20, tags:['rhetoric','street'],
  ...
  text:`Gideon has flagged a line in tomorrow's draft, about what immigration does to the country, and the verb ` +
       `he's underlined is a medical one. "Sir, two historians will have columns filed before you finish the sentence."`,
  choices:[
    { label:`Keep it. Deliver it twice.`, eff:{base:+9,street:-12,press:-5,congress:-8,courts:-4,auth:+7},
      res:`The columns run within the hour and both quote the identical 1920s speech. Your team calls the critics obsessed with history, which is true, and also not remotely a defence.` },
    { label:`Change the verb. Keep the argument.`, eff:{base:+6,street:-4,press:-3,congress:-3,auth:+5},
      res:`Same policy, same crowd noise, zero archival footage to haunt you. Gideon calls it the cheapest edit of his career.` },
    { label:`Cut it. Talk about wage competition instead.`, eff:{street:+7,press:+7,congress:+6,courts:+4,base:-7,auth:+1},
      res:`An economic argument that is arguable, defensible and dull as drywall. It persuades four hundred thousand more people than the other version and delights precisely nobody.` },
...
{ id:'a-energy-emergency', title:`The Energy Emergency`, who:C.energy, min:1, max:12, tags:['economy','power'],
  ...
  text:`Cassandra Doyle has the day-one package ready: an energy emergency declaration and the revocation of eleven ` +
       `predecessor orders. "Production is at a record high, sir. That's the number the declaration has to survive."`,
  choices:[
    { label:`Declare it anyway. Record output, still an emergency.`, eff:{base:+8,street:-7,courts:-7,press:-5,congress:-5,cash:+0.3,auth:+10},
      res:`The declaration unlocks permitting powers that have nothing to do with scarcity, because scarcity was never actually the point, and the record production figures keep publishing themselves monthly regardless.` },
    { label:`Revoke the orders. Skip the emergency.`, eff:{base:+5,street:-4,courts:-3,press:-3,auth:+6},
      res:`Same practical effect, nothing left to litigate over a declaration. Four environmental groups sue over the revocations instead and lose on standing.` },
    { label:`Keep the orders. Claim the record output as yours.`, eff:{street:+7,press:+7,congress:+5,base:-8,auth:+1},
      res:`The record predates you by two years. You take the credit anyway and nobody can be bothered to correct it.` },
    { label:`Declare an energy emergency and a surplus, same morning.`, eff:{base:+3,street:-5,press:-5,courts:-4,auth:+4}, wild:true,
      res:`Two proclamations, twenty minutes apart, flatly contradicting each other, both still in force. A trade journal spends 4,000 words trying to reconcile them and fails.` }]},
...
{ id:'a-wind', title:`The Moratorium`, who:C.energy, min:2, max:16, tags:['economy','street'],
  ...
  text:`"A halt on new wind leasing on federal land. Eleven projects at final permit stage, four thousand jobs, ` +
       `and most of it sitting in states you won by double digits." Cassandra waits.`,
  choices:[
    { label:`Halt all of it. Immediately.`, eff:{base:+7,street:-8,courts:-6,press:-5,congress:-5,auth:+8},
      res:`Four thousand jobs freeze across five states you carried. Two governors from your own party object on the record, and one of them is on every shortlist you own.` },
    { label:`Halt new leases. Let the eleven finish.`, eff:{base:+5,street:-3,courts:-2,press:-2,auth:+6},
      res:`Symbolism without casualties. Your base hears the word "halt" and the eleven projects hear absolutely nothing at all.` },
    { label:`No moratorium. Approve them and cut the ribbon.`, eff:{street:+8,press:+7,congress:+5,base:-9,auth:+1},
      res:`You pose in a hard hat in front of a turbine. Your own side runs the photograph against you for the next four years.` },
    { label:`Ban wind on federal land, then buy the turbines yourself.`, eff:{base:+4,street:-5,press:-4,cash:-0.4,auth:+3}, wild:true,
      res:`You acquire eleven half-built wind farms at a discount your own order created. Four ethics offices open files and not one of them can name the actual violation.` }]},
...
{ id:'a-pipelines', title:`The Two Pipelines`, who:C.energy, min:2, max:14, tags:['economy','street'],
  ...
  text:`Two pipelines, both halted by the last administration, both revivable by memorandum. ` +
       `"One crosses a river four hundred metres upstream of a reservation's water intake. That is the entire dispute, right there."`,
  choices:[
    { label:`Approve both. Memorandum, today.`, eff:{base:+8,street:-9,courts:-8,press:-5,cash:+0.4,auth:+9},
      res:`Construction begins in nine weeks. The camp that forms upstream lasts eleven months and produces the defining protest photograph of your first year.` },
    { label:`Approve one. Re-route the other.`, eff:{base:+5,street:-3,courts:-3,press:-2,cash:+0.3,auth:+6},
      res:`The re-route runs $400 million and two extra years and draws zero legal challenges. Both pipelines are pumping by 2031.` },
    { label:`Approve both, and fund the reservation's new intake.`, eff:{base:+3,street:+6,courts:+5,press:+5,cash:+0.2,auth:+4},
      res:`$90 million for a water plant erases the objection at its root. Four tribal chairs say so publicly, which surprises absolutely everyone, themselves included.` },
    { label:`Approve a third pipeline nobody has proposed.`, eff:{base:+4,street:-4,press:-4,courts:-3,auth:+3}, wild:true,
      res:`It has no route, no operator and no application. It is announced at a rally and appears in four state energy plans before anybody confirms it does not exist.` }]},
...
{ id:'a-climate-money', title:`The Pledges`, who:C.state, min:6, max:20, tags:['foreign','money'],
  ...
  text:`Three countries were promised transition financing on the strength of an American signature. ` +
       `Muriel: "We can withdraw it, it was pledged, not appropriated. Trouble is, they've already broken ground."`,
  choices:[
    { label:`Withdraw all three pledges.`, eff:{base:+6,street:-6,press:-6,congress:-5,cash:+0.4,auth:+7},
      res:`Two of the three projects find other financing within eighteen months. You have not saved a dollar, you have just handed the relationship to somebody else.` },
    { label:`Withdraw two. Honour the one under construction.`, eff:{base:+4,press:-3,congress:-2,cash:+0.3,auth:+5},
      res:`A distinction nobody demanded, purchased for $600 million, that preserves exactly one relationship. Muriel calls it the best afternoon of her year.` },
    { label:`Honour all three. Rename the programme after yourself.`, eff:{street:+7,press:+8,congress:+6,base:-6,cash:-0.5,auth:+2},
      res:`The projects get built, the plaques say what you asked, and three governments now owe you a favour you never once collect on.` },
    { label:`Withdraw the money and offer coal instead.`, eff:{base:+5,street:-6,press:-6,congress:-4,cash:+0.2,auth:+3}, wild:true,
      res:`All three decline. One does it in a letter so exquisitely polite it gets framed and hung in their embassy in Washington.` }]},
...
{ id:'a-tapes-post', title:`The Tapes`, who:C.lawyer, min:4, max:18, tags:['justice','press'],
  ...
  text:`You have drafted a post suggesting the man you just fired had better hope there are no recordings of your ` +
       `conversations. Sy: "Sir, there are two ways to read that. One is a bluff. The other is that there is something on a tape."`,
  choices:[
    { label:`Post it. Let him wonder.`, eff:{base:+6,courts:-9,congress:-8,press:-5,auth:+6},
      res:`He tells a committee your own post is exactly why he kept his memos. You have triggered the disclosure you were trying to prevent, in one sentence, free of charge.` },
    { label:`Post it, then confirm there are no tapes a month later.`, eff:{base:+4,courts:-5,congress:-4,press:-4,auth:+4},
      res:`A full month of national speculation over a recording system that never existed, ended by you, at no cost to anybody except the month.` },
    { label:`Say nothing. He is fired and it is over.`, eff:{courts:+8,congress:+7,press:+6,base:-5,auth:+1},
      res:`It is, genuinely, over. Sy calls it the single best decision of the first year and means every word.` },
    { label:`Install a recording system, then post it.`, eff:{base:+3,courts:-8,congress:-7,press:-6,auth:+5}, wild:true,
      res:`You manufacture the evidence in order to threaten somebody with it. Four lawyers explain the problem in sequence, each explanation grimmer than the last.` }]},
...
{ id:'a-let-this-go', title:`"I Hope You Can"`, who:C.fbi, min:3, max:16, tags:['justice','courts'],
  ...
  choices:[
    { label:`"I hope you can see your way to letting this go."`, eff:{base:+4,courts:-11,congress:-10,press:-5,auth:+8}, breaks:'takecare',
      res:`She writes it down in her car twenty minutes later, dates it, and hands copies to three people. The word "hope" gets litigated for two years.` },
    { label:`Say nothing about the case. Talk about anything else.`, eff:{courts:+9,congress:+8,press:+6,base:-4,auth:+2},
      res:`Eleven minutes on hostage policy. She leaves confused and writes down nothing, which is the only outcome that actually helps you.` },
    { label:`Ask her, on the record, with counsel present.`, eff:{courts:+5,congress:+4,press:+4,base:-2,auth:+3},
      res:`Asking improperly with a witness in the room converts a deniable conversation into a documented one, but at least it is a conversation you can defend.` },
    { label:`Ask her to investigate you instead, as a distraction.`, eff:{base:+3,courts:-4,congress:-4,press:-4,auth:+4}, wild:true,
      res:`She opens the file. It is a real file with a real number. It is still open in 2029 and nobody involved meant for any of it to happen.` }]},
...
{ id:'a-no-quid', title:`The Three Words`, who:C.press, min:10, max:22, tags:['press','congress'],
  ...
  text:`Kaylee has counted: you have used the same three-word Latin phrase eleven times in four days. ` +
       `"Sir, nobody has said that phrase in public life for a decade. It is on a coffee mug now."`,
  choices:[
    { label:`Use it again. Louder. It is a good phrase.`, eff:{base:+6,congress:-7,press:-5,street:-4,auth:+5},
      res:`Repeating a denial nobody asked for is how you invent the question. By week three the phrase is shorthand for the exact thing it denies.` },
    { label:`Stop saying it entirely. Never again.`, eff:{congress:+6,press:+6,street:+4,base:-3,auth:+3},
      res:`Silence starves it out in nine days. It is the correct call, and from the inside it feels exactly like losing.` },
    { label:`Release the call record and let people read it.`, eff:{congress:+7,courts:+6,press:+8,base:-6,auth:-2},
      res:`It is worse than the summary and better than the speculation. Publishing it kills four competing rumours and starts one accurate one.` },
    { label:`Sell the coffee mug.`, eff:{base:+7,congress:-5,press:-4,street:-3,cash:+0.2,auth:+2}, wild:true,
      res:`Four hundred thousand units at $28 apiece, the second best-selling item the movement has ever produced, and it prints the Latin for "not a bribe" right on the side.` }]},
...
{ id:'a-withheld-aid', title:`The Hold`, who:C.treas, min:12, max:24, tags:['foreign','congress'],
  ...
  text:`"Four hundred million dollars, appropriated, obligated, and currently sitting on a hold that traces back to this building." ` +
  ...
  choices:[
    { label:`Keep the hold. Give no reason.`, eff:{base:+4,congress:-11,courts:-8,street:-6,press:-5,auth:+10}, breaks:'purse',
      res:`An unexplained hold on appropriated money generates four separate inquiries, two of them statutory, and you do not get to decline either.` },
    { label:`Release it. Say it was a review.`, eff:{congress:+8,courts:+6,press:+5,base:-4,auth:+3},
      res:`Released 55 days late with a two-line explanation attached. An auditor notices the delay. Nobody else does.` },
    { label:`Keep it and tie it to a stated policy condition.`, eff:{congress:-5,courts:-4,press:-4,base:+5,auth:+7},
      res:`A written condition is a policy instrument. An unwritten one is a favour. Putting it in writing is the less catastrophic of two bad options.` },
    { label:`Release it in a currency they cannot spend.`, eff:{base:+2,congress:-6,courts:-4,press:-4,auth:+4}, wild:true,
      res:`The transfer arrives denominated in a unit nobody has used since 1971. Their finance ministry spends four months converting it and sends a thank-you note anyway.` }]},
...
{ id:'a-fifty-forty-eight', title:`Fifty–Forty-Eight`, who:C.speaker, min:8, max:22, tags:['courts','congress'],
  ...
  text:`Hal has the count: fifty for, forty-eight against, and two members who will decide in the last hour. ` +
       `The hearing has been extraordinary in a way nobody in the room will get to forget.`,
  choices:[
    { label:`Whip it to the floor tonight. Two votes is a majority.`, eff:{base:+8,courts:+10,congress:-8,street:-8,press:-6,auth:+9}, breaks:'consent',
      res:`Confirmed by two votes. He serves thirty years, and the hearing gets replayed at every confirmation after this one, by both parties, for opposite reasons.` },
    { label:`Pause for a one-week supplementary inquiry.`, eff:{courts:+7,congress:+5,street:+6,press:+6,base:-5,auth:+4},
      res:`The inquiry resolves nothing in either direction. He is confirmed 53-45 nine days later; the extra week costs you nothing and buys four senators political cover.` },
    { label:`Withdraw him. Nominate the next name.`, eff:{courts:+5,congress:+7,street:+7,press:+7,base:-11,auth:-2},
      res:`The replacement is confirmed 61-39 and is, by every measure, more reliably aligned with you. Your base experiences the withdrawal as total, unforgivable defeat.` },
    { label:`Nominate both of them. Two seats, one vote.`, eff:{base:+3,courts:-5,congress:-6,press:-4,auth:+4}, wild:true,
      res:`There is exactly one vacancy. The second nomination gets transmitted anyway and sits on the Senate calendar for four years, technically, eternally pending.` }]},
...
{ id:'a-eight-days', title:`Eight Days Out`, who:C.ag, min:10, max:24, tags:['courts','elections'],
  ...
  text:`A justice has died with the election eight days away. Bo: "There is no rule against it. ` +
       `There is, however, a thing four senators said in 2016 that they will now have to eat, on camera, in sequence."`,
  choices:[
    { label:`Confirm before the election. Eight days is eight days.`, eff:{base:+9,courts:+11,congress:-9,street:-8,press:-6,auth:+10}, breaks:'consent',
      res:`Sworn in with six days to spare. The four senators eat their old quote on camera, in sequence, and every one of them is still re-elected.` },
    { label:`Nominate now, confirm after. Same outcome, less heat.`, eff:{base:+6,courts:+9,congress:-4,street:-4,press:-4,auth:+8},
      res:`Identical result a fortnight later with a third of the coverage. Timing turns out to be the only variable that mattered, and it was worth more than the argument.` },
    { label:`Leave it to whoever wins.`, eff:{congress:+9,courts:+7,street:+8,press:+8,base:-12,auth:-6},
      res:`You lose the election and the seat. It is the most principled thing you do in four years, and it ends four relationships inside your own party.` },
    { label:`Confirm them to a seat that is not vacant.`, eff:{base:+3,courts:-6,congress:-5,press:-4,auth:+4}, wild:true,
      res:`A tenth justice is confirmed to a Court that seats nine. She shows up, gets an office, and quietly does legal research for four years.` }]},
...
{ id:'a-order-struck', title:`Permanently Struck`, who:C.lawyer, min:10, max:26, tags:['courts','power'],
  ...
  text:`A judge has struck your order against the firm, permanently, in an opinion using the word "unconstitutional" ` +
       `nine times. Sy: "She did not enjoin it, sir. She voided it. There is nothing left to appeal."`,
  choices:[
    { label:`Attack the ruling. Sign a near-identical order.`, eff:{base:+7,courts:-11,press:-6,congress:-6,street:-5,auth:+8},
      res:`The second order is voided in eleven days by the same judge, who quotes her own opinion at length and staples the first order on as an exhibit.` },
    { label:`Comply. Restore the clearances. Say nothing.`, eff:{courts:+9,congress:+6,press:+7,base:-7,auth:-1},
      res:`The firm is made whole within a fortnight. Four other firms that had already quietly caved reverse their concessions, which is the real cost.` },
    { label:`Comply, and target the firm through procurement instead.`, eff:{base:+5,courts:-4,press:-5,congress:-4,auth:+9},
      res:`No order, no ruling, no headline, just contracts that quietly stop renewing. It works, and there is nothing left for any judge to void.` },
    { label:`Hire the judge.`, eff:{base:+3,courts:-7,congress:-5,press:-5,auth:+4}, wild:true,
      res:`She declines by letter in four sentences flat. The letter is entered on the docket, goes public, and becomes the funniest document filed all year.` }]},
...
{ id:'a-accountability-order', title:`The Accountability Order`, who:C.ag, min:6, max:22, tags:['justice','power'],
  ...
  text:`"An order directing agencies to review the conduct of named former officials." Bo turns the page. ` +
       `"Sir, four of these names investigated you personally. One of them is 81 and retired."`,
  choices:[
    { label:`Sign it. All the names.`, eff:{base:+8,courts:-10,congress:-8,press:-6,street:-6,auth:+11}, breaks:'dueprocess',
      res:`Clearances first, then background files, then pension reviews. Nothing is ever charged. Everything is done anyway, because none of it required a charge.` },
    { label:`Sign it with the retired ones removed.`, eff:{base:+5,courts:-6,press:-4,congress:-4,auth:+8},
      res:`Sparing the 81-year-old is the entire difference between "policy" and "vendetta" in the coverage, and in no other respect whatsoever.` },
    { label:`Do not sign. Order a review of the reviews instead.`, eff:{courts:+7,congress:+6,press:+6,base:-6,auth:+2},
      res:`A meta-review reports back in fourteen months, finds procedural irregularities on all sides, and satisfies nobody, which is precisely what reviews are for.` },
    { label:`Sign it and add your own name to the list.`, eff:{base:+4,courts:+5,press:+6,congress:+4,auth:+3}, wild:true,
      res:`You are reviewed by your own department under your own order. It clears you in nine weeks, and the clearance is worth exactly what it cost to produce.` }]},
...
{ id:'a-ethics-divest', title:`The Divestment Briefing`, who:C.ethics, min:1, max:12, tags:['money','press'],
  ...
  text:`Miriam Applewhite lays out the standard package: sell the assets outright, or a genuine blind trust run by a stranger. ` +
       `"There is a third thing people call a blind trust and hand to their children instead. It is not blind, sir. It is just a trust."`,
  choices:[
    { label:`The trust. Run by the family. Call it blind.`, eff:{base:+4,press:-9,courts:-7,congress:-6,cash:+0.7,auth:+8},
      res:`You get briefed on its performance over dinner. Every filing calls it blind, and every filing is, technically, accurate about the paperwork.` },
    { label:`Full divestment. Sell everything.`, eff:{press:+10,congress:+8,courts:+7,street:+5,base:-4,cash:-1.0,auth:-2},
      res:`It costs a fortune and permanently retires an entire category of story. You will not appreciate this for roughly three years.` },
    ...
    { label:`Put it in a trust run by a stranger you then hire.`, eff:{base:+3,press:-6,courts:-5,congress:-4,cash:+0.5,auth:+6}, wild:true,
      res:`He is appointed to a federal advisory board eleven weeks later. Four journalists spot it the same afternoon, and not one can prove the connection.` }]},
...
{ id:'a-gift-log', title:`The Gift Log`, who:C.ethics, min:4, max:20, tags:['money','foreign'],
  ...
  text:`Eleven hundred inaugural gifts from foreign governments. Anything above the threshold legally belongs to the country, not you. ` +
       `Item 402 is a solid gold horse. Item 403 is a bigger one.`,
  choices:[
    { label:`Log them. Buy the horses back at valuation.`, eff:{press:+7,congress:+5,courts:+4,cash:-0.4,auth:+2},
      res:`Entirely legal, fully documented, and it costs $600,000 for two gold horses you never wanted and cannot display anywhere in the building.` },
    { label:`Log them as displayed at a residence. Keep them.`, eff:{base:+3,press:-7,courts:-6,congress:-5,cash:+0.5,auth:+6},
      res:`The residence is yours. The "display" is a hallway. By any ordinary use of the word, the horses have simply been kept.` },
    { label:`Auction the lot for veterans. Publicly.`, eff:{base:+5,press:+8,street:+8,congress:+5,cash:+0.1,auth:+2},
      res:`$2.1 million raised in an afternoon. A ceremonial dagger goes to a twelve-year-old, producing a brief, genuinely delightful international incident.` },
    { label:`Melt the horses. Mint coins with your face on them.`, eff:{base:+6,press:-6,courts:-5,congress:-4,cash:+0.3,auth:+4}, wild:true,
      res:`The gifting government requests a photograph of the horses for its own archive. You send them a photograph of the coins instead.` }]},
...
{ id:'a-property-billing', title:`The Rate Card`, who:C.home, min:6, max:24, tags:['money','press'],
  ...
  text:`Duane has the invoices. The protective detail has paid your own resort $1.1 million in room rates in four months. ` +
       `"Sir, we have to stay where you stay. And you set the rate."`,
  choices:[
    { label:`Keep the rate. It is the market rate.`, eff:{base:+3,press:-8,courts:-6,congress:-6,cash:+0.5,auth:+6}, breaks:'emoluments',
      res:`The taxpayer now pays the President to protect the President at the President's own hotel. It is disclosed, itemised, entirely lawful, and that is the whole problem.` },
    { label:`Charge them one dollar a year.`, eff:{press:+8,congress:+7,street:+5,base:+3,cash:-0.3,auth:+2},
      res:`A cheap, theatrical, devastatingly effective gesture that kills the story for the price of a sandwich.` },
    { label:`Stay somewhere you do not own.`, eff:{press:+6,congress:+5,street:+4,base:-3,cash:-0.2},
      res:`Camp David gets called "fine, actually" by three separate aides. You never go back after the second visit.` },
    { label:`Charge them, then bill yourself for the inconvenience.`, eff:{base:+3,press:-6,courts:-5,congress:-4,cash:+0.4,auth:+4}, wild:true,
      res:`An invoice from you, to you, paid by the government, for the disruption caused by your own protection. It clears. Nobody can identify who signed off on it.` }]},
...
{ id:'a-family-desk', title:`The Desk In The West Wing`, who:C.girl, min:2, max:18, tags:['money','power'],
  ...
  text:`Ivy would like a West Wing office, a security clearance and an unpaid senior title. ` +
  ...
  choices:[
    { label:`All three. Override the flags.`, eff:{base:+4,press:-8,courts:-6,congress:-6,street:-4,auth:+7},
      res:`She is genuinely capable, and the job could not have gone to anybody who was not your daughter. Both things are true, and only one makes the papers.`, flag:'family' },
    { label:`Title and office. No clearance.`, eff:{base:+3,press:-3,congress:-2,auth:+4},
      res:`She sits in on the meetings anyway, from a chair by the door, and outperforms four confirmed officials without ever seeing a classified page.` },
    { label:`No family in the building.`, eff:{press:+9,congress:+7,courts:+6,street:+5,base:-6},
      res:`The correct decision, full stop. It also removes the one person alive who would have told you the truth in a small room.` },
    { label:`Give her the clearance, and give the flags a clearance too.`, eff:{base:+3,press:-5,courts:-5,congress:-4,auth:+5}, wild:true,
      res:`The two career officers who objected get read into the very programme they objected to. Both immediately object again, now with considerably more detail.` }]},
...
{ id:'a-columbia', title:`The Second University`, who:C.edu, min:10, max:26, tags:['culture','power'],
  ...
  text:`Four hundred million dollars, one university, and a list of demands about protest policy and departmental oversight. ` +
       `Ollis: "The first one folded fast. This one has a bigger endowment and a worse lawyer."`,
  choices:[
    { label:`Cut it. All four hundred million.`, eff:{base:+8,street:-9,courts:-8,press:-7,congress:-5,auth:+11},
      res:`They fold in nine weeks and accept an outside monitor over one department. Eleven other universities read the settlement and skip the phone call entirely.` },
    { label:`Cut half. Leave the medical research alone.`, eff:{base:+5,street:-4,courts:-4,press:-4,auth:+8},
      res:`Sparing the cancer labs removes the only argument that was actually landing. Same leverage, no photograph of a shuttered clinical trial.` },
    { label:`Fund it fully. Attack them rhetorically instead.`, eff:{street:+6,courts:+6,press:+6,congress:+4,base:-5,auth:+2},
      res:`Words cost nothing and change nothing. The university ignores you completely and its applications rise 14% anyway.` },
    { label:`Cut the funding and enrol in a seminar there.`, eff:{base:+5,street:+4,press:+5,courts:-3,auth:+2}, wild:true,
      res:`You audit four sessions of a constitutional law course at the institution you are defunding. The transcript surfaces in 2044 and is, unexpectedly, a good read.` }]},
...
{ id:'a-minors-care', title:`The Age Line`, who:C.health, min:6, max:22, tags:['culture','courts'],
  ...
  text:`Dr. Pike has the draft. "It conditions federal funding on hospitals ending a category of care for under-19s. ` +
       `Four children's hospitals in states you won will stop the day you sign it."`,
  choices:[
    { label:`Sign it. Nineteen and under, no exceptions.`, eff:{base:+9,street:-9,courts:-8,press:-6,congress:-5,auth:+9}, breaks:'equal',
      res:`Nine hospitals halt within a fortnight, mid-course for some patients. Two courts partially enjoin it, and the hospitals do not restart anyway, because hospitals never restart.` },
    { label:`Sign it with an exception for continuing care.`, eff:{base:+6,street:-4,courts:-4,press:-3,auth:+7},
      res:`Nobody gets dropped mid-treatment. It achieves the policy without producing the four specific cases that would have defined it in every headline.` },
    { label:`No order. Fund a longitudinal study instead.`, eff:{street:+7,press:+7,courts:+6,congress:+4,base:-9,cash:-0.2,auth:+1},
      res:`It reports back in nine years with the largest dataset anyone has ever assembled. Both sides cite it selectively and neither one budges an inch.` },
    { label:`Set the age line at 47.`, eff:{base:+3,street:-5,courts:-5,press:-4,auth:+3}, wild:true,
      res:`A drafting instruction taken literally by somebody who did not want to ask questions. It is caught in review after four days, and the story never quite dies.` }]},
...
{ id:'a-military-dei', title:`The Fighting Force Order`, who:C.gen, min:4, max:20, tags:['culture','military'],
  ...
  text:`Tarrant lays the order and the retention data side by side. "I will implement whatever you sign, sir. ` +
  ...
  choices:[
    { label:`Sign it. Close every office.`, eff:{base:+8,street:-8,congress:-6,press:-5,courts:-4,auth:+9}, breaks:'equal',
      res:`Recruitment in those four specialties drops 19% over two years. The report proving it gets classified at a level that keeps it out of the budget hearing.` },
    { label:`Close the offices. Keep the recruitment pipelines.`, eff:{base:+5,street:-3,congress:-3,press:-3,auth:+7},
      res:`The sign comes down, the function stays, renamed. Everybody gets exactly what they said they wanted, and nothing whatsoever actually changes.` },
    { label:`Do not sign. Order a readiness review first.`, eff:{street:+7,congress:+7,press:+6,courts:+4,base:-8,auth:+1},
      res:`The review finds the programmes marginally positive and mildly expensive. You sign a narrower order nine months later and nobody bothers objecting.` },
    { label:`Sign it and replace the offices with a single sergeant.`, eff:{base:+4,street:-5,congress:-4,press:-4,auth:+4}, wild:true,
      res:`Sergeant Alvarez inherits the workload of four hundred people, does the job better than all four hundred combined, and gets promoted twice in a year.` }]},
...
{ id:'a-passports', title:`The Marker`, who:C.state, min:4, max:20, tags:['culture','street'],
  ...
  choices:[
    { label:`Hold them indefinitely. Issue no guidance.`, eff:{base:+7,street:-9,courts:-8,press:-6,congress:-4,auth:+9}, breaks:'dueprocess',
      res:`A hold with no decision attached cannot be appealed, because nothing has technically been decided. It is the most efficient refusal in the department's history.` },
    { label:`Refuse them formally. Give them something to appeal.`, eff:{base:+6,street:-6,courts:-5,press:-4,auth:+6},
      res:`A formal refusal is litigable, and is duly litigated. You lose in fourteen months, which, notably, is fourteen months.` },
    { label:`Process them. Change the policy prospectively.`, eff:{street:+8,courts:+7,press:+6,congress:+4,base:-8,auth:+2},
      res:`Eleven thousand applications clear in six weeks, and the new rule applies to everyone after. Nobody misses a flight and nobody even notices.` },
    { label:`Issue every passport with no marker at all.`, eff:{base:+3,street:-4,courts:-5,press:-4,auth:+4}, wild:true,
      res:`Four countries refuse the documents at their borders. The department spends nine months negotiating recognition for a field it deleted on purpose.` }]},
...
{ id:'a-ninety-day', title:`The Ninety-Day Pause`, who:C.treas, min:10, max:24, tags:['economy','press'],
  ...
  choices:[
    { label:`Pause everything. Raise the one rate to 125%.`, eff:{base:+7,street:+5,congress:+3,press:-4,cash:+0.3,auth:+6}, breaks:'presentment',
      res:`Markets rip upward 9% in an afternoon. A few people who knew about the pause forty minutes early get considerably richer, and four inquiries into it go nowhere.` },
    ...
    { label:`Pause nothing. Hold the line.`, eff:{base:+8,street:-11,congress:-8,press:-5,cash:-0.4,auth:+5},
      res:`Another 6% comes off in a week. Retirement accounts absorb the hit, and your approval among the over-60s does something pollsters call, technically, geological.` },
    { label:`Pause them, and announce the pause four times.`, eff:{base:+4,street:+3,press:-4,auth:+3}, wild:true,
      res:`Four separate announcements of the identical pause over nine days, each one moving the market. A trade journal calls it the most profitable stutter in financial history.` }]},
...
{ id:'a-retaliation', title:`The Answer`, who:C.state, min:12, max:26, tags:['economy','foreign'],
  ...
  text:`Two partners have answered. One has hit four agricultural states with surgical precision. ` +
       `The other has done nothing official at all, its citizens have simply stopped buying American products.`,
  choices:[
    { label:`Escalate against both.`, eff:{base:+7,street:-9,congress:-8,press:-5,cash:-0.4,auth:+7},
      res:`The precision targeting doubles overnight. The boycott, having no official status to negotiate with, cannot be talked down, and runs for eleven years.` },
    { label:`Negotiate with the state. Ignore the boycott.`, eff:{street:+5,congress:+5,press:+4,base:-4,auth:+4},
      res:`You settle with the government in four months. Consumer sentiment takes nine years to recover, and no agreement ever so much as touches it.` },
    { label:`Drop the tariffs. Declare the point made.`, eff:{street:+8,congress:+7,press:+7,base:-8,auth:+1},
      res:`Everything unwinds in six weeks. Two minor concessions bought for eleven months of disruption, an honest, if unimpressive, result.` },
    { label:`Boycott them back. Personally. On camera.`, eff:{base:+6,street:-4,press:-3,congress:-3,auth:+2}, wild:true,
      res:`You publicly forswear their four most famous products. Domestic sales of all four rise. One country mails you a free case with a very short note attached.` }]},
...
{ id:'a-strike-timing', title:`The Timings`, who:C.gen, min:8, max:24, tags:['security','press'],
  ...
  text:`Your defence secretary posted launch windows and target packages into a commercial chat app two hours before the aircraft flew. ` +
  ...
  choices:[
    ...
    { label:`Remove him. Say exactly why.`, eff:{street:+8,congress:+9,press:+8,courts:+5,base:-8,auth:-2},
      res:`Accountability, stated plainly, once. Four allied services quietly restore the intelligence sharing they had paused the previous month.` },
    { label:`Keep him. Ban the app across government.`, eff:{street:+4,congress:+4,press:+3,base:+2,auth:+5},
      res:`A policy fix without a personnel fix. It solves this specific failure and precisely none of the reasons it happened.` },
    { label:`Add the aircrew to the chat so they get it faster.`, eff:{base:+3,street:-6,congress:-5,press:-5,auth:+3}, wild:true,
      res:`Somebody actually attempts this before being physically stopped. The attempt lands in an inspector general report as a numbered finding.` }]},
...
{ id:'a-war-plans', title:`"Nobody Was Texting"`, who:C.press, min:8, max:26, tags:['press','security'],
  ...
  choices:[
    { label:`Hold the line. Repeat the denial after they publish.`, eff:{base:+6,press:-11,congress:-9,street:-6,courts:-4,auth:+5},
      res:`The screenshots contain the actual words. Denying it after the evidence is public converts a security failure into a credibility one, permanently.` },
    { label:`Concede the facts. Dispute the significance.`, eff:{base:+3,press:+4,congress:+3,street:+3,auth:+4},
      res:`Arguing about whether it was serious is a fight you can survive. Arguing about whether it happened is not, and you wisely decline the second one.` },
    { label:`Get ahead of it. Release the messages yourself at four.`, eff:{press:+9,congress:+7,street:+6,courts:+4,base:-5,auth:+2},
      res:`Publishing first kills the scoop and the cover-up in one move. The magazine runs its piece anyway, a third as long as it would have been.` },
...
{ id:'a-cabinet-praise', title:`Around The Table`, who:C.vp, min:3, max:18, tags:['vanity','power'],
  ...
  text:`Chet suggests opening the televised cabinet meeting by going round the table so each secretary can say ` +
       `what serving you has meant to them personally. "It humanises the team," he says, looking directly at you.`,
  choices:[
    { label:`Do it. Go round twice.`, eff:{base:+8,press:-9,street:-6,congress:-5,courts:-4,auth:+6},
      res:`Forty-one minutes of grown adults thanking a man, on live television, for the privilege of employment. A comparative-politics professor pauses the tape and says "there it is" out loud, to an empty room.` },
    { label:`Do it, but cut it after four.`, eff:{base:+5,press:-3,auth:+4},
      res:`Four is enough to establish the ritual without generating the full supercut. Chet notes the number and files it away.` },
    { label:`"We are not doing that. Report on your agencies."`, eff:{press:+8,congress:+6,street:+5,courts:+4,base:-5,auth:-2},
      res:`A genuinely productive meeting with nine real decisions in it. Chet spends the whole hour writing in a small notebook, unsure what has happened.` },
    { label:`Go round the table thanking each of them instead.`, eff:{base:+3,press:+7,street:+6,congress:+6,auth:-1}, wild:true,
      res:`You name one specific thing each of the twenty-two has done. It runs fifty minutes, four are visibly moved, and Chet cannot work out what he is watching.` }]},
...
{ id:'a-crowd-number', title:`The Aerials`, who:C.press, min:1, max:6, tags:['press','vanity'],
  ...
  text:`The aerial photographs are out. The crowd is real, enthusiastic, and roughly the size of a regional dog show. ` +
       `The paper has run both years side by side, in case anyone missed it.`,
  choices:[
    { label:`Send Kaylee out to say it was the largest ever. Period.`, eff:{base:+7,press:-9,street:-4,congress:-3,auth:+4},
      res:`She says it with her whole chest. Nobody believes a word of it, everybody notices she said it anyway, and that was always the entire point of sending her.` },
    { label:`"Crowds are a media obsession." Next question.`, eff:{base:-2,press:+5,street:+3,auth:+1},
      res:`The story dies in forty minutes. Something in you dies along with it.` },
    { label:`Order the Park Service to release corrected figures.`, eff:{base:+5,press:-7,courts:-5,street:-4,auth:+6},
      res:`A career photo archivist gets reassigned to a windowless room in Suitland. The number is now 1.9 million, written down, and official.` },
    { label:`Count them yourself. On television. Out loud.`, eff:{base:+5,press:-4,street:-3,auth:+2}, wild:true,
      res:`You reach four hundred and eleven before losing your place entirely. It airs in full and becomes, by some distance, the most-watched arithmetic in television history.` }]},
...
{ id:'a-misspellings', title:`The Catalogue`, who:C.social, min:4, max:30, tags:['gaffe','press'],
  ...
  text:`A fact-checking desk has been cataloguing your spelling for eleven months. The list stands at 340 entries. ` +
  ...
  choices:[
    { label:`Keep posting unedited. It is authentic.`, eff:{base:+7,press:-5,street:-3,auth:+3},
      res:`The catalogue balloons to 900 entries. It is also, genuinely, why four million people believe you write your own posts, which, unfortunately, you do.` },
    { label:`Have somebody proofread before posting.`, eff:{press:+6,congress:+4,street:+3,base:-6,auth:+1},
      res:`Engagement drops 22% within a month. Correct spelling reads as a committee, and a committee reads, to your base, as everybody else.` },
    { label:`Misspell one word deliberately every time. Own it.`, eff:{base:+8,press:-3,street:-2,auth:+3},
      res:`It becomes a signature, then a shibboleth. Supporters start misspelling it back at you, and the fact-checkers quietly stop counting.` },
    { label:`Announce that the dictionary is wrong.`, eff:{base:+5,press:-5,street:-4,congress:-3,auth:+3}, wild:true,
      res:`Four lexicographers respond with genuine delight, and one writes a surprisingly good essay on descriptivism that goes unexpectedly viral.` }]},
...
{ id:'a-khan', title:`The Parents`, who:C.gen, min:6, max:26, tags:['military','press'],
  ...
  choices:[
    { label:`Answer him. Question the mother's silence.`, eff:{base:+3,street:-13,press:-6,congress:-10,courts:-4,auth:+2},
      res:`It runs for eleven days. Four members of your own party break from you by name, and every serving officer hears about it, most saying nothing at all, which is its own message.` },
    { label:`Say nothing at all. Send a private letter.`, eff:{street:+8,press:+7,congress:+6,base:-4,auth:+1},
      res:`The letter is never published. He mentions, years later, that it was handwritten and better than he expected, and declines to say anything more.` },
    { label:`Praise the son by name at the next event.`, eff:{street:+9,press:+8,congress:+7,base:-3,auth:+1},
      res:`You get the rank and the unit right, without notes. Thirty seconds long, and the single most effective thing you do all month.` },
    { label:`Buy four thousand pocket Constitutions and hand them out.`, eff:{base:+4,street:+6,press:+7,congress:+5,cash:-0.1,auth:-1}, wild:true,
      res:`They sell out nationally within a week. The publisher writes to thank you. Four of your own orders subsequently get quoted right back at you, from copies you paid for.` }]},
...
{ id:'a-deferred-resignation', title:`The Offer`, who:C.cos, min:2, max:16, tags:['agencies','power'],
  ...
  text:`"An email to every federal employee. Resign now, keep getting paid through September, no questions asked." ` +
  ...
  choices:[
    { label:`Send it to all 2.3 million. Work out the money later.`, eff:{base:+7,congress:-9,courts:-8,street:-9,press:-6,auth:+12},
      res:`Seventy-seven thousand accept. The ones with somewhere else to go leave first, air traffic control, nuclear security, disease surveillance, because they always do.` },
    { label:`Send it only where you actually want reductions.`, eff:{base:+4,street:-4,congress:-3,press:-3,auth:+8},
      res:`Precision instead of a blunderbuss. Same headcount reduction, only in the places you actually chose, and the reactor inspectors stay put.` },
    { label:`Do not send it. Reduce by attrition.`, eff:{street:+7,congress:+6,courts:+5,press:+5,base:-7,auth:+2},
      res:`The workforce shrinks 4% a year without a single email sent. Slower, cheaper, and it generates zero litigation whatsoever.` },
    { label:`Send it, then send a second email retracting it.`, eff:{base:+2,street:-6,congress:-5,press:-5,auth:+4}, wild:true,
      res:`Eleven thousand people have already resigned by the time the retraction lands. Four refuse to un-resign on principle, and remain, permanently, correct to have done so.` }]},
...
{ id:'a-thirty-days', title:`Thirty Days' Notice`, who:C.lawyer, min:1, max:12, tags:['power','congress'],
  ...
  text:`"The statute requires thirty days' written notice to Congress before you remove an inspector general. ` +
       `One sentence." Sy shrugs. "There is no penalty section. I have checked four times."`,
  choices:[
    { label:`Skip the notice. Remove them tonight by email.`, eff:{base:+5,congress:-9,courts:-8,press:-6,auth:+11}, breaks:'takecare',
      res:`A judge rules it unlawful in eight months and declines to reinstate anybody, reasoning you would simply re-fire them correctly the second time. She is right, and says so in the opinion.`, flag:'igPurge' },
    ...
    { label:`Keep them. Cut their budgets instead.`, eff:{congress:+3,courts:+3,press:+2,base:-2,auth:+5},
      res:`Their reports now arrive eleven months late, in black and white, unbound. Nobody reads them, which was, apparently, the whole requirement.` },
    { label:`Give thirty days' notice for one and fire the rest.`, eff:{base:+3,congress:-6,courts:-6,press:-5,auth:+8}, wild:true,
      res:`The one compliant removal gets cited in every filing as proof of good faith. One out of seventeen turns out to be a surprisingly effective ratio.` }]},
...
{ id:'a-rule-count', title:`Ninety-Eight In A Row`, who:C.energy, min:6, max:22, tags:['agencies','street'],
  ...
  text:`Cassandra has a spreadsheet. "Ninety-eight rules could be revoked. Individually, each is a technical amendment ` +
       `nobody covers. Together, it is the largest environmental change since 1970, and nobody is going to cover that either."`,
  choices:[
    { label:`All ninety-eight. One a week. Never announce them.`, eff:{base:+6,street:-10,courts:-9,press:-5,cash:+0.4,auth:+11},
      res:`Two years of Federal Register notices. Four get reported. The cumulative effect is measurable from orbit and never once makes a front page.` },
    { label:`The twelve that actually cost jobs. Defend those loudly.`, eff:{base:+5,street:-4,courts:-4,press:-3,auth:+7},
      res:`A defensible position you can actually win on television, which happens to be nine-tenths of the value of any position at all.` },
    { label:`None. Fund the transition in the affected counties.`, eff:{street:+9,press:+8,courts:+6,congress:+5,base:-8,cash:-0.4,auth:-2},
      res:`Eleven thousand retraining places open across four states you won. It works, slowly, and your successor cuts the ribbon on it.` },
    { label:`Revoke ninety-eight rules and write ninety-nine new ones.`, eff:{base:+3,street:-5,courts:-5,press:-4,auth:+5}, wild:true,
      res:`The replacement set is longer, stricter, and drafted by the identical career staff. Nobody in the building notices for eleven months.` }]},
...
{ id:'a-smoot', title:`The Comparison`, who:C.treas, min:8, max:22, tags:['economy','press'],
  ...
  text:`Lyle has one page. "Every economist asked has reached for the same 1930 comparison. Not most of them, sir. ` +
       `All of them. Including four who technically work for you."`,
  choices:[
    { label:`Embrace the comparison. That tariff built the country.`, eff:{base:+8,street:-8,congress:-7,press:-5,auth:+7},
      res:`It did not. It is the most studied policy failure in American economic history, and all four of your own economists say so, in writing, that same week.` },
    { label:`Reject the comparison. Argue the differences.`, eff:{street:+5,congress:+5,press:+5,base:-3,auth:+4},
      res:`There are genuine differences and you argue them competently. The most substantive twenty minutes of your presidency, and it rates dismally.` },
    { label:`Ban the comparison from official communications.`, eff:{base:+5,press:-7,street:-5,congress:-4,auth:+5},
      res:`A word cannot, in fact, be banned. Its usage rises 400% within a fortnight, entirely because you tried.` },
    { label:`Name the tariff after the 1930 one, deliberately.`, eff:{base:+5,street:-6,press:-5,congress:-5,auth:+4}, wild:true,
      res:`Claiming the comparison before anyone else can make it is either brilliant or catastrophic, and four separate books eventually reach four separate conclusions about which.` }]},
...
{ id:'a-first-of-many', title:`"The First, Perhaps, Of Many"`, who:C.gen, min:12, max:26, tags:['military','street'],
  ...
  choices:[
    { label:`"The first, perhaps, of many."`, eff:{base:+8,street:-12,courts:-8,congress:-9,press:-6,auth:+10}, breaks:'posse',
      res:`Four governors pre-emptively activate their own Guards just to deny you the pretext. One sentence has just changed the military posture of a third of the country.` },
    { label:`"This one. For this. That is all."`, eff:{street:+8,congress:+7,courts:+6,press:+6,base:-7,auth:+1},
      res:`The deployment ends in three weeks and nothing follows it. Limiting language is the cheapest de-escalation available, and it costs you exactly one rally line.` },
    { label:`Refuse to answer. Let them wonder.`, eff:{base:+5,street:-7,courts:-5,congress:-5,auth:+8},
      res:`Deliberate ambiguity does the work of a threat without the accountability of one. Every governor plans for the worst, and not one of them can quote you on it.` },
    { label:`"The first of exactly three." Name the three.`, eff:{base:+4,street:-9,courts:-6,congress:-6,auth:+6}, wild:true,
      res:`You name three cities off the top of your head. All three sue within the week. One of them was not on any list anybody had actually prepared.` }]}
